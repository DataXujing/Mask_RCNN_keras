...
IMAGE_DIR ="./myData/coco/images/val"
...
for file_name in filenames:
    ...
    # Visualize results
    print("推断时间：{}".format((end_time-start_time).seconds))
    r = results[0]
    ...
    cv2.putText(image_BGR, "Inference Time {} s".format((end_time-start_time).seconds), (40,40), font, 2, (0,255,0), 3)
    cv2.imwrite("./test/"+file_name,image_BGR)
    # cv2.imshow("Mask R-CNN", image_BGR)
    # cv2.waitKey(0)
