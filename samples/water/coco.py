...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 coco.py train --dataset=./myData/coco/ --model=imagenet --download=True
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN on my owndata, like coco label data.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'evaluate' on mydata")
    parser.add_argument('--dataset', required=True,
                        metavar="/path/to/coco/",
                        help='Directory of the my own dataset')
